...
function builder(options) {
  ...
  if (!options.network) {
    options.network = botcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || botcore.Block;
  options.BlockHeader = options.BlockHeader || botcore.BlockHeader;
  options.Transaction = options.Transaction || botcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || botcore.MerkleBlock;
